...
if __name__ == "__main__": from prompts import message_prompt, conversation_prompt, response_prompt
else: from lib.prompts import message_prompt, conversation_prompt, response_prompt
        ...
        try:
            async with semaphore:
                resp = await client.chat.completions.create(
                    model="gpt-4.1-mini",
                    messages=[match_prompt[prompt], txt], # type: ignore
                    response_format={
                        "type": "json_schema",
